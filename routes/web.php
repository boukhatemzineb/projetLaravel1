...
Route::resource('EventA',EventController::class);
Auth::routes();
...
Route::get('supprimer',[App\Http\Controllers\OppsController::class,'destroy'])->name('supprimer');
 ...
 Route::get('/afficherevent/{id}', [App\Http\Controllers\EventController::class, 'afficher'])->name('afficherevent');
...
Route::get('/afficherevent', function () {
    return view('afficherevent');
});
