    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand text-dark"class="img-circle elevation-2" href="#page-top"><img src="" > Boukhatem Zineb</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link text-dark" href="{{route('affevent',['id'=>1])}}">Mes Event</a></li>
                    </ul>
                </div>
            </div>
        </nav>
